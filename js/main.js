  ...
  // fixed navigation header add sticky class on scroll
    ...
    function myFunction() {
      if (window.pageYOffset > sticky) {
        ...
        $('.custom-logo').replaceWith( "<img src='/wp-content/uploads/2018/12/spoex-logo-white.svg' class='custom-logo' alt='SPOEX' itemprop='logo'>" );
      } else {
        header.classList.remove("sticky");
        $('.custom-logo').replaceWith( "<img src='/wp-content/uploads/2018/12/spoex-logo-round-white.svg' class='custom-logo' alt='SPOEX' itemprop='logo'>" );
      }
    };
  });
